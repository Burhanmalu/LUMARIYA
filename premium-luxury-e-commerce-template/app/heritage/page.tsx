...
const timeline = [
  {
    ...
    title: "The Beginning",
    description:
      "Giuseppe LUMARIYA established our first atelier in Florence, crafting bespoke leather goods for Italian nobility. His vision was simple: create pieces that transcend time.",
  },
  {
    year: "1892",
    title: "Royal Appointment",
    description:
      "Recognized for exceptional craftsmanship, LUMARIYA received its first royal warrant, establishing a tradition of serving discerning clientele across Europe.",
  },
  {
    year: "1935",
    title: "The Signature Stitch",
    description:
      "Third-generation artisan Marco LUMARIYA perfected our distinctive hand-stitching technique, now recognized worldwide as the hallmark of authentic LUMARIYA pieces.",
  },
  {
    year: "1978",
    title: "Global Expansion",
    description:
      "While maintaining our Florence atelier as the heart of production, LUMARIYA opened boutiques in Paris, Milan, and New York, sharing Italian excellence with the world.",
  },
  {
    year: "2024",
          ...
          >
            ...
            <cite className="not-italic">
              <span className="block text-sm tracking-[0.2em] uppercase text-muted-foreground">
                — Isabella LUMARIYA, Creative Director
              </span>
            </cite>
          </motion.blockquote>
        </div>
