          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="flex items-center gap-4 mb-10">
              ...
              <button
                ...
                className={`text-sm tracking-[0.15em] uppercase transition-colors ${step === "payment" ? "text-foreground" : "text-muted-foreground"
                  }`}
              >
                Payment
              </button>
            ...
            <div className="lg:sticky lg:top-32">
              ...
              <div className="border-t border-border pt-6 space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground text-xs uppercase tracking-widest">Subtotal</span>
                  <span className="font-medium">₹{subtotal.toLocaleString()}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground text-xs uppercase tracking-widest">Shipping</span>
                  <span className="text-green-600 font-medium">Complimentary</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-muted-foreground text-xs uppercase tracking-widest">GST (18%)</span>
              ...
              <div className="mt-8 p-6 bg-muted/30 border border-border">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <p className="text-[10px] tracking-widest uppercase text-muted-foreground">Secure Payment Guarantee</p>
                </div>
                <p className="text-xs text-muted-foreground leading-relaxed italic">
                  All orders include signature gift packaging. Expected delivery within 5–7 business days.
                </p>
              </div>
            </div>
          </div>
