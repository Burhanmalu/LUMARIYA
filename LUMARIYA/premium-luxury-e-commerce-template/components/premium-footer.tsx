...
export function PremiumFooter() {
  const footerLinks = {
    shop: [
      ...
      { label: "Daily Wear Rida", href: "/shop?category=Daily Wear Rida" },
      { label: "Party Wear Rida", href: "/shop?category=Party Wear Rida" },
      { label: "Festival Wear Rida", href: "/shop?category=Festival Wear Rida" },
      { label: "Wedding Rida", href: "/shop?category=Wedding Rida" },
      { label: "Majlis Rida", href: "/shop?category=Majlis Rida" },
    ],
    about: [
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div className="pt-8 border-t border-background/20 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs text-background/50">
            ...
            <span>© 2026 LUMARIYA. All rights reserved.</span>
          </div>
        </div>
      </div>
    </footer>
