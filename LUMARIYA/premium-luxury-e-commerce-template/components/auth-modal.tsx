            ...
            <DialogContent className="sm:max-w-md bg-white/95 backdrop-blur-xl border-white/20">
                <DialogHeader>
                    ...
                    <DialogDescription className="text-sm text-neutral-600">
                        {isLogin ? 'Sign in to continue shopping' : 'Join LUMARIYA for exclusive access'}
                    </DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4 py-4">
                    ...
                    <div className="space-y-3">
                        <Button
                            type="button"
                            variant="outline"
                            className="w-full h-12 border-neutral-200 hover:bg-neutral-50 transition-all"
                    ...
                    <form onSubmit={handleEmailAuth} className="space-y-4">
                        ...
                        <Button
                            type="submit"
                            className="w-full h-12 bg-black text-white hover:bg-neutral-800 transition-all"
                            disabled={loading}
                        >
